...
class DetailFooter: UIView {
    ...
    convenience init(frame: CGRect, data: DetailData, nav: UINavigationController) {
    ...
    func isCollect () {
        ...
        AlamofireUtil.post(url:"/user/myCollect/isCollect", param: ["itemId" : detailData?.itemid! as! String],
        success:{(res,data) in
    ...
    func collect () {
        AlamofireUtil.post(url:"/user/myCollect/addCollect", param: [
            "type" : 1,
            "itemId" : detailData?.itemid! as! String,
            "itemPic" : detailData?.itempic! as! String,
            "shopType" : detailData?.shoptype! as! String,
            "shopName" : detailData?.shopname! as! String,
            "itemTitle" : detailData?.itemtitle! as! String,
            "itemSale" : detailData?.itemsale! as! String,
            "itemPrice" : detailData?.itemprice! as! String,
            "itemEndPrice" : detailData?.itemendprice! as! String,
            "couponMoney" : detailData?.couponmoney! as! String,
            "money" : detailData?.tkmoney! as! String
        ],
        success:{(res,data) in
