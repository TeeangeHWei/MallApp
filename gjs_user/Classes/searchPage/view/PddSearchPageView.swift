...
@available(iOS 11.0, *)
class PddSearchPageView: UIScrollView {
    ...
    convenience init(frame: CGRect, nav: UINavigationController) {
        ...
        // banner
        let banner = UIImageView(image: UIImage(named: "search-banner-pdd"))
        ...
        let historyArr = UserDefaults.getHistoryPdd() as! [String]
