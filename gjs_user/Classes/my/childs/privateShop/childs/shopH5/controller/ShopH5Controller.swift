...
class ShopH5Controller : UIViewController, WKNavigationDelegate {
    ...
    var webAddress = "https://www.ganjinsheng.com/shop?relationId=2203488441"
    
    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
//        setNav(titleStr: "个人商城", titleColor: kMainTextColor, navItem: navigationItem, navController: navigationController)
