...
@objc public class jdTestBaseView: UIView {
...
extension jdTestBaseView: UITableViewDataSource, UITableViewDelegate {
...
extension jdTestBaseView: JXPagingViewListViewDelegate {
