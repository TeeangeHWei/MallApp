...
@objc protocol PageControlViewDataScoure : class {
    @objc func PageControlViewDataScoure(contentView: PageContentView, cellForItemAt indexPath: IndexPath) -> PageControllCell
}
...
class PageContentView: UIView {
    ...
    // 自定义数据源协议
    weak var dataScoure : PageControlViewDataScoure?
    // 禁止点击的时候走代理的方法
...
extension PageContentView : UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (dataScoure != nil) {
            ...
            let item = dataScoure?.PageControlViewDataScoure(contentView: self, cellForItemAt: indexPath)
            return item!
        }
