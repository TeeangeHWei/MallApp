...
class YPRollNoticeView: UIView {
    ...
    func getDataToView(_ data: pamaModel){
        self.labelOne1.text = data.copy_text
        self.labelTwo2.text = data.copy_text
    }
    ...
    override init(frame: CGRect) {
        ...
        self.labelOne1 = labelOne
        self.labelTwo2 = labelTwo
